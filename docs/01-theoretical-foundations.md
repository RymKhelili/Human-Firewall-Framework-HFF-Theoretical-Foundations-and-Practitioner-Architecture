...
When I looked into this, I found that organizations have spent more and more on security awareness training for over two decades (Gartner & Cybersecurity Ventures), driven by the well-documented fact that most breaches involve a human element somewhere along the way(The 2026 Verizon DBIR documents that the human element was present in 62% of all confirmed data breaches). The usual response to that fact, In my observations, has been to train harder: more frequent modules, more simulated phishing campaigns, more mandatory quizzes. But as I worked through the independent research, I found a large and growing body of work concluding that this approach doesn't reduce incidents, and in some cases makes the underlying problem worse. Tu, Z., et al. (2023). "The Effects of Phishing Simulations on Employee Behavior: A Long-Term Field Study." IEEE Transactions on Engineering Management.
...
The lesson I take from this for training design is direct: a program built on top of a blame narrative is working against its own goal before you've even shown a single slide.
...
Taken together, this evidence is a randomized trial of nearly 20,000 people, several European university studies, industry breach-investigation data, and what employees themselves report tells me more than just "awareness training is weak." It tells me that the standard way training is delivered (once a year, fact-heavy, out of context, graded with pass/fail simulations) is fundamentally mismatched to the mental processes it's trying to change. To understand why, I had to turn to cognitive science.
...
Tu, Z., et al. (2023). "The Effects of Phishing Simulations on Employee Behavior: A Long-Term Field Study." IEEE Transactions on Engineering Management.
